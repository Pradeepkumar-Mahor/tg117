...
namespace tg117.Domain.Migrations
{
    ...
    [Migration("20250122072559_addCourseAndProjectClass")]
    partial class addCourseAndProjectClass
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tg117.Domain.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("tg117.Domain.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("tg117.Domain.Models.OrderHeader", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("tg117.Domain.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("tg117.Domain.Models.OrderDetails", b =>
                {
                    b.HasOne("tg117.Domain.Models.OrderHeader", "OrderHeader")
                        .WithMany()
